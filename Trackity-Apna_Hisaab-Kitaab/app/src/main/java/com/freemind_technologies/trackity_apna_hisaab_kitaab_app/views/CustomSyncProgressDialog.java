...
public class CustomSyncProgressDialog extends Dialog {

    public CustomSyncProgressDialog(@NonNull Context context) {
        super(context);
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.db_sync_layout, null);
        setContentView(view);
